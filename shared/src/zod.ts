...
export const zPeriodRequared = z.enum(['week', 'month', 'all']).default('month')
export const zYearOptional = z.number().int().min(2000).max(2100).optional()
export const zMonthOptional = z.number().int().min(1).max(12).optional()
